...
exports.run = async (client, message, args) => {
    ...
    if (message.author.id !== '536378372314497035' && message.author.id !== '' && message.author.id !== '') return message.reply("<:7775:593645935280783431> | você não possui permissão para usar esse comando.")
